...
static int ieee80211_update_mesh_vendor_ie(struct wiphy *wiphy,
				      struct net_device *dev,
				      const struct mesh_vendor_ie *vendor_ie)
{
	...
	sdata = IEEE80211_DEV_TO_SUB_IF(dev);
	ifmsh = &sdata->u.mesh;
	memcpy(ifmsh->vendor_ie, vendor_ie->ie, vendor_ie->ie_len);
	ifmsh->vendor_ie_len = vendor_ie->ie_len;
	ieee80211_mbss_info_change_notify(sdata, BSS_CHANGED_BEACON);
	return 0;
}
...
const struct cfg80211_ops mac80211_config_ops = {
	...
	.update_mesh_vendor_ie = ieee80211_update_mesh_vendor_ie,
#endif
